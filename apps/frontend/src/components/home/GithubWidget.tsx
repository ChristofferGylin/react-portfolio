...
const GithubWidget = () => {
    ...
    return (
        <div className="justify-self-center self-center w-full lg:w-120 2xl:w-148 3xl:w-200 h-fit border border-cyan-300 foreground rounded-xl flex flex-col p-5 shadow shadow-cyan-200/30">
